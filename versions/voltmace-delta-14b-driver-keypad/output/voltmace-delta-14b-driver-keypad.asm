...
; so the now-plain BASIC front-end starts. Preserves A, X and Y (saved and restored
; around the body); the flags are not saved.
;
; On Exit:
;     A: preserved
;     X: preserved
...
.relocate_image
    ldx #<(oscli_command)                                             ; 39aa: a2 f1       ..       ; Point X/Y at oscli_command (&39F1): low byte...
    ldy #>(oscli_command)                                             ; 39ac: a0 39       .9       ; ...high byte...
