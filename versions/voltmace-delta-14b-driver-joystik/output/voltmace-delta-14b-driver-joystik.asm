...
.decode_basic
    ...
    ldx #<(driver_a_template_encoded)                                 ; 1927: a2 00       ..       ; Point decode_ptr at the encoded region (&1A00): low byte...
    stx decode_ptr                                                    ; 1929: 86 80       ..       ; ...
    ldx #>(driver_a_template_encoded)                                 ; 192b: a2 1a       ..       ; ...high byte...
...
.decode_next_byte
    ...
    inx                                                               ; 193e: e8          .        ; ...
    cpx #>(basic_raw_tail)                                            ; 193f: e0 4b       .K       ; ...until basic_raw_tail (page &4B); the raw tail is left alone
